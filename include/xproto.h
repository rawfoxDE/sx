...
struct XPR_IO {
                STRPTR        xpr_filename;
                  ...
                  LONG (* ASM xpr_fclose)(REG(a0) BPTR);
                  LONG (* ASM xpr_fread)(REG(a0) APTR,REG(d0) LONG,REG(d1) LONG,REG(a1) BPTR);
                  LONG (* ASM xpr_fwrite)(REG(a0) APTR,REG(d0) LONG,REG(d1) LONG,REG(a1) BPTR);
                  LONG (* ASM xpr_sread)(REG(a0) APTR,REG(d0) ULONG,REG(d1) ULONG);
                  LONG (* ASM xpr_swrite)(REG(a0) UBYTE *,REG(d0) LONG);
                  LONG (* ASM xpr_sflush)(VOID);
                  LONG (* ASM xpr_update)(REG(a0) struct XPR_UPDATE *);
                  LONG (* ASM xpr_chkabort)(VOID);
                  LONG (* ASM xpr_chkmisc)(VOID);
